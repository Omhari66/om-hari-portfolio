...
export function MusicPlayer({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative cursor-pointer select-none h-40 w-40 md:h-48 md:w-48"
        onClick={togglePlay}
      ...
      >
        ...
        >
          {/* Tonearm base */}
          <div className="absolute top-0 right-0 w-6 h-6 md:w-8 md:h-8 rounded-full bg-zinc-400 dark:bg-zinc-600 shadow-md transform translate-x-1/2 -translate-y-1/2 border-2 border-zinc-200 dark:border-zinc-800 z-10" />
          {/* Tonearm stick & Needle */}
          <div className="absolute top-0 right-[10px] sm:right-[15px] w-[90%] h-1.5 md:h-2 bg-zinc-400 dark:bg-zinc-500 rounded-full origin-right -rotate-12 shadow-sm flex items-center justify-start">
            {/* Needle */}
            <div className="w-3 h-3 md:w-4 md:h-4 bg-zinc-800 dark:bg-zinc-300 rounded-full shadow-md transform -translate-x-1/2" />
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/3 h-1/3 rounded-full bg-zinc-900 border border-zinc-700 shadow-inner flex items-center justify-center">
            ...
            <div className="w-2 h-2 md:w-3 md:h-3 bg-zinc-300 dark:bg-zinc-600 rounded-full shadow-inner border border-black/40" />
          </div>
        </div>
      </div>
    </div>
